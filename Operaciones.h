...
public:
    List() : head(nullptr) {}  // Constructor que inicializa la lista vacía
    ...
    void PushBack(T value)
    {
        ...
        if (head == nullptr)  // Si la lista está vacía, el nuevo nodo se convierte en el primer nodo
        {
            head = newNode;
        }
        else  // Si la lista no está vacía, se agrega el nuevo nodo al final
        {
    ...
    void Reverse()
    {
        ...
        head = prev;  // Actualiza el puntero al primer nodo para que apunte al último nodo (después de invertir)
    }
...
// Nota final para terminar el codigo se tuvo que ver muchos videos de todoas las funciones y como aplicarlas esto lo hacemos para 
// ampliar nuestro conocimiento a lo que estamos practicando de la tarea y lo anterior son paginas que nos sirvieron para investigar 
// para que se note que no es plagio jamas hemos tomado ningun codigo copiado o solo pegado en eete proyecto de tarea.
